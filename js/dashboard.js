        ...
        <div class="modal" id="methodModal" onclick="if(event.target === this || event.target.classList.contains('modal-backdrop')) closeMethodModal()">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>ციტირება:</strong> მონაცემების გადმოწერის და გამოყენების შემთხვევაში, გთხოვთ, წყარო მიუთითოთ შესაბამის ფორმატში - <i>თბილისის საზოგადოებრივი ტრანსპორტის დინამიკა - თბილისის სატრანსპორტო კომპანია, Z.axis (2026).</i></p>
                </div>
            </div>
        </div>
